...
char_data* one_character( char_data* ch, char* argument,
  char* text, thing_array* a1, thing_array* a2,
  thing_array* a3 )
{
  ...
  visible_array*   array  [ 3 ]  = {(visible_array*) a1,
                                    (visible_array*) a2,
                                    (visible_array*) a3 };
  if( *argument == '\0' ) {
...
thing_data* one_thing( char_data* ch, char* argument, char* text, thing_array* a1, thing_array* a2, thing_array* a3, thing_array* a4 )
{
    return (thing_data*) one_visible( ch, argument, text, (visible_array*) a1, (visible_array*) a2, (visible_array*) a3, (visible_array*) a4 );
}


visible_data* one_visible( char_data* ch, char* argument, char* text, visible_array* a1, visible_array* a2, visible_array* a3, visible_array* a4, visible_array* a5 )
{
  char               tmp  [ MAX_INPUT_LENGTH ];
  int             number;
  int              count  = 0;
