...
cfunc code_get_pos;
cfunc code_get_undead;
cfunc code_get_skeleton;
cfunc code_get_room;
cfunc code_has_obj;
...
cfunc code_remark;
cfunc code_remove_aff;
cfunc code_rem_not_aff;
// remove_status
cfunc code_remove_status;
cfunc code_is_affected;
cfunc code_has_status;
cfunc code_is_hidden;
cfunc code_uncamouflage;
cfunc code_unhide;
cfunc code_deinvis;
cfunc code_is_invis;
cfunc code_is_camouflaged;
cfunc code_can_see;
cfunc code_sees_hidden;
cfunc code_sees_invis;
cfunc code_is_exhausted;
cfunc code_is_locked;
cfunc code_is_fighting;
cfunc code_is_follower;
cfunc code_is_following;
// Sadis -- is_mob()
cfunc code_is_mob;
