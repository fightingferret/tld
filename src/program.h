...
bool   check_oprogs        ( char_data*, char*, char* );
int    trigger_to_number   ( char * );
void   check_trigger_oprog ( char_data*, obj_data*, int );
...
// SADIS - two more trigger types
#define MPROG_TRIGGER_TIME         13
#define MPROG_TRIGGER_BASH         14
#define MAX_MPROG_TRIGGER          15
...
// sadis - added trigger type time
#define OPROG_TRIGGER_TIME         15
