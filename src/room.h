...
#define RFLAG_RESET3               29
#define RFLAG_RESET4               30
#define RFLAG_RESET5               31
#define RFLAG_NO_NIGHT_ONLY        32
#define RFLAG_NO_SPAWN_UNDEAD      33
#define MAX_RFLAG                  34
