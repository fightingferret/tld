...
/*
  if( ( t1 = one_thing( ch, arg, "social",
    ...
    return TRUE;
*/
  if( ( t1 = one_visible( ch, arg, "social",
    (visible_array*) &ch->in_room->exits,
    (visible_array*) &ch->contents,
    (visible_array*) ch->array ) ) == NULL )
    return TRUE;
  ...
  if( *argument == '\0' ) {
    if( obj != NULL )
      ...
      social_dir( ch, soc1, soc2, ex->direction );
    else if( victim == ch )
...
/*
  if( ( t2 = one_thing( ch, argument, "social",
    ...
    return TRUE;
*/
  if( ( t2 = one_visible( ch, argument, "social",
    (visible_array*) &ch->in_room->exits,
    (visible_array*) &ch->contents,
    (visible_array*) ch->array ) ) == NULL )
    return TRUE;
