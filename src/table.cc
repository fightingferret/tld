...
entry_data table_entry [ MAX_TABLE-MAX_PLYR_RACE ][ MAX_FIELD ] =
{
  ...
  {
    { &qc_table[0].name,                          VAR_CHAR   },
    { &qc_table[0].position,                      VAR_INT    },
    { &qc_table[0].layer,                         VAR_INT    },
    { &qc_table[0].attrib[0],                     VAR_INT    },
    { &qc_table[0].attrib[1],                     VAR_INT    },
    { &qc_table[0].attrib[2],                     VAR_INT    },
    { &qc_table[0].hitroll[0],                    VAR_INT    },
    { &qc_table[0].hitroll[1],                    VAR_INT    },
    { &qc_table[0].hitroll[2],                    VAR_INT    },
    { &qc_table[0].damroll[0],                    VAR_INT    },
    { &qc_table[0].damroll[1],                    VAR_INT    },
    { &qc_table[0].damroll[2],                    VAR_INT    },
    { &qc_table[0].res[0],                        VAR_INT    },
    { &qc_table[0].res[1],                        VAR_INT    },
    { &qc_table[0].max_res[0],                    VAR_INT    },
    { &qc_table[0].max_res[1],                    VAR_INT    },
    { &qc_table[0].stat[0],                       VAR_INT    },
    { &qc_table[0].stat[1],                       VAR_INT    },
    { &qc_table[0].max_stat[0],                   VAR_INT    },
    { &qc_table[0].max_stat[1],                   VAR_INT    },
    { &qc_table[0].regen[0],                      VAR_INT    },
    { &qc_table[0].regen[1],                      VAR_INT    },
    { &qc_table[0].regen[2],                      VAR_INT    },
    { &qc_table[0].max_regen[0],                  VAR_INT    },
    { &qc_table[0].max_regen[1],                  VAR_INT    },
    { &qc_table[0].max_regen[2],                  VAR_INT    },
    { &qc_table[0].ac[0],                         VAR_INT    },
    { &qc_table[0].ac[1],                         VAR_INT    },
    { &qc_table[0].ac[2],                         VAR_INT    },
    { &qc_table[0].ac[3],                         VAR_INT    }
  } 
};
...
const char* table_name [ MAX_TABLE ] = { "Soc.Default",
  ...
  "Help.Categories", "Astral", "Religions", "Alignments", "Qc" };
...
const char* qc_fields[] = { "Name", "Position", "Layer",
  "Attrib1", "Attrib2", "Attrib3", "Hitroll1", "Hitroll2", "Hitroll3",
  "Damroll1", "Damroll2", "Damroll3", "Res1", "Res2", "Max.Res1", 
  "Max.Res2", "Stat1", "Stat2", "Max.Stat1", "Max.Stat2", "Regen1",
  "Regen2", "Regen3", "Max.Regen1", "Max.Regen2", "Max.Regen3", 
  "Ac.WarPal", "Ac.Ran", "Ac.CleThi", "Ac.MonMag", ""
};
