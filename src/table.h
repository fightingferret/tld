...
#define AFF_RABIES                 68

#define AFF_BURNING                0
#define AFF_FLAMING                1
#define FIRST_POISON               2
#define AFF_POISON_POISON          2
#define AFF_POISON_LOW             3
#define AFF_POISON_MID             4
#define AFF_POISON_HIGH            5
#define AFF_POISON_STUN            6
#define MAX_POISON                 5
