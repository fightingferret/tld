...
vd* one_visible        ( cd*, char*, char*, va*, va*, va* = NULL, va* = NULL, va* = NULL );
va* several_visible    ( cd*, char*, char*, va*, va*, va* = NULL, va* = NULL );
td* one_thing          ( cd*, char*, char*, ta*, ta* = NULL, ta* = NULL, ta* = NULL );
