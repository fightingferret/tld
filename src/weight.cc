...
const char* burden_name [] = { "unburdened", "lightly burdened", "encumbered", "heavily burdened", "strained", "stressed", "over-taxed" };
...
{
    int default_weight [] = { 10, 200, 2000, 5000, 15000, 35000, 100000, 150000, 400000, 1000000 }; 
...
{
    if( ( pIndexData->item_type != ITEM_WEAPON && pIndexData->item_type != ITEM_ARMOR ) || !is_set( pIndexData->extra_flags, OFLAG_RANDOM_METAL ) )
        return weight;
